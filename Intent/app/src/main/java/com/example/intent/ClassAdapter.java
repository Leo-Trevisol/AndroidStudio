 ...
 class ClassAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            view = inflater.inflate(R.layout.celula,parent,false);


            viewPersonsagem = new MainActivity.ViewPersonagem();
            viewPersonsagem.icone = (ImageView) view.findViewById(R.id.img);
            viewPersonsagem.titulo = (TextView) view.findViewById(R.id.text);
